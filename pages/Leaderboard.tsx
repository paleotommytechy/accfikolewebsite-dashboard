        ...
        <div className="flex justify-center items-end gap-4 md:gap-8 p-4 border-b dark:border-gray-700">
          ...
          {topThree[1] && (
            <div className="text-center">
              <Avatar src={topThree[1].avatarUrl} alt={topThree[1].name} size="lg" className="border-4 border-gray-400" />
          ...
          {topThree[0] && (
            <div className="text-center">
              <Avatar src={topThree[0].avatarUrl} alt={topThree[0].name} size="xl" className="border-4 border-yellow-400" />
          ...
          {topThree[2] && (
            <div className="text-center">
              <Avatar src={topThree[2].avatarUrl} alt={topThree[2].name} size="lg" className="border-4 border-yellow-700" />
