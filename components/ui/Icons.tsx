...
export const CrownIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="currentColor" viewBox="0 0 24 24">
        <path d="M12 2L9.46 6.31L4 6.94L8.13 10.4L6.91 15.5L12 12.89L17.09 15.5L15.87 10.4L20 6.94L14.54 6.31L12 2M19.97 18.84L20.83 14.31L18.29 12.15L19.16 7.62L14.62 7.17L12 3L9.38 7.17L4.84 7.62L5.71 12.15L3.17 14.31L4.03 18.84L8.55 17.5L12 20L15.45 17.5L19.97 18.84Z" />
    </svg>
);
...
export const GoogleIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg className={className} viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
        ...
        <path fill="#1976D2" d="M43.611 20.083H42V20H24v8h11.303c-.792 2.237-2.231 4.166-4.087 5.571l6.19 5.238C42.012 35.398 44 30.092 44 24c0-1.341-.138-2.65-.389-3.917z"/>
    </svg>
);
...
export const PaperAirplaneIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 8.5L21 3l-6.5 18L11 13 3 8.5z" />
    </svg>
);
...
export const BoldIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8 5v14m0-7h5.5a4.5 4.5 0 000-9H8a0 0 0 000 0v0m5.5 9H8" />
    </svg>
);
